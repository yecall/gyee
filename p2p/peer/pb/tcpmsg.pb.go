...
func (ProtocolId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{0}
}
...
func (MessageId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{1}
}
...
func (KeyStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{2}
}
...
func (*P2PMessage_Protocol) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{1, 0}
}
...
func (*P2PMessage_Handshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{1, 1}
}
...
func (*P2PMessage_Ping) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{1, 2}
}
...
func (*P2PMessage_Pong) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{1, 3}
}
...
func (*ExtMessage_CheckKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{2, 0}
}
...
func (*ExtMessage_ReportKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_d1da78e6376a4612, []int{2, 1}
}
...
func init() { proto.RegisterFile("tcpmsg.proto", fileDescriptor_tcpmsg_d1da78e6376a4612) }

var fileDescriptor_tcpmsg_d1da78e6376a4612 = []byte{
