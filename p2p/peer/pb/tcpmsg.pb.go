...
func (ProtocolId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{0}
}
...
func (MessageId) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{1}
}
...
func (KeyStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{2}
}
...
func (*P2PMessage_Protocol) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{1, 0}
}
...
func (*P2PMessage_Handshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{1, 1}
}
...
func (*P2PMessage_Ping) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{1, 2}
}
...
func (*P2PMessage_Pong) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{1, 3}
}
...
type ExtMessage struct {
	...
	ReportKeyFromPeer    *ExtMessage_ReportKey `protobuf:"bytes,3,opt,name=reportKeyFromPeer" json:"reportKeyFromPeer,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *ExtMessage) GetReportKeyFromPeer() *ExtMessage_ReportKey {
	if m != nil {
		return m.ReportKeyFromPeer
	}
	return nil
}
...
func (*ExtMessage_CheckKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{2, 0}
}
...
func (*ExtMessage_ReportKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcpmsg_242fd9ef5c23dd17, []int{2, 1}
}
...
func (m *ExtMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReportKeyFromPeer != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTcpmsg(dAtA, i, uint64(m.ReportKeyFromPeer.Size()))
		n5, err := m.ReportKeyFromPeer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *ExtMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReportKeyFromPeer", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReportKeyFromPeer == nil {
				m.ReportKeyFromPeer = &ExtMessage_ReportKey{}
			}
			if err := m.ReportKeyFromPeer.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("tcpmsg.proto", fileDescriptor_tcpmsg_242fd9ef5c23dd17) }

var fileDescriptor_tcpmsg_242fd9ef5c23dd17 = []byte{
	// 715 bytes of a gzipped FileDescriptorProto
	,
}
