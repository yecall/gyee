...
func (m *DhtMessage_PutProvider) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Provider == nil {
		...
		n24, err := m.Provider.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *DhtMessage_GetProviderRsp) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Provider == nil {
		...
		i++
		i = encodeVarintDhtmsg(dAtA, i, uint64(m.Provider.Size()))
		n29, err := m.Provider.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
var fileDescriptorDhtmsg = []byte{
	...
	,
}
