...
func configGenesis_mainToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/genesis_main.toml", size: 822, mode: os.FileMode(420), modTime: time.Unix(1550223720, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func configGenesis_testToml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/genesis_test.toml", size: 822, mode: os.FileMode(420), modTime: time.Unix(1550223727, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
