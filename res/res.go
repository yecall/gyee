...
// sources:
// config/config_test.toml
// config/genesis_main.toml
// config/genesis_test.toml
...
func libraryBignumberJs() (*asset, error) {
	bytes, err := libraryBignumberJsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "library/bignumber.js", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"config/config_test.toml": configConfig_testToml,
	"config/genesis_main.toml": configGenesis_mainToml,
	"config/genesis_test.toml": configGenesis_testToml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"config": &bintree{nil, map[string]*bintree{
		"config_test.toml": &bintree{configConfig_testToml, map[string]*bintree{}},
		"genesis_main.toml": &bintree{configGenesis_mainToml, map[string]*bintree{}},
		"genesis_test.toml": &bintree{configGenesis_testToml, map[string]*bintree{}},
	}},
