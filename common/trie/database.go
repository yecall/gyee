...
type Database struct {
	diskdb persistent.Storage // Persistent storage for matured trie nodes
...
func NewDatabaseWithCache(diskdb persistent.Storage, cache int) *Database {
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > persistent.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch persistent.Batch) error {
